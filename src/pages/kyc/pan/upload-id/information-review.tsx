...
import Information from "./images/information-review.svg";
import { useNavigate } from "react-router-dom";

export interface InformationReviewProps { }

const InformationReview: FC<InformationReviewProps> = () => {
    const navigate = useNavigate()
    useEffect(() => {
        const timer = setTimeout(() => {
            navigate('/kyc/pan/review-success');
        }, 3000);
