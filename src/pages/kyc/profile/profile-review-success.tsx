...
import Tick from "../pan/upload-id/images/tick.svg";
import { t } from "i18next";
import { useNavigate } from "react-router-dom";

export interface ProfileReviewSuccessProps { }
const ProfileReviewSuccess: FC<ProfileReviewSuccessProps> = () => {
            ...
            <div className="text-center pt-[8px]">
                ...
                <div className="w-[262px] h-[30px] pt-[8px]">
                    <p className="text-sm font-normal font-poppins text-[#1D2939] text-center">
                        You will be auto redirected in a few seconds
                    </p>
                </div>
            </div>
        </div>
...
export default ProfileReviewSuccess;
